...
<body>
  <div id="id01" class="modal">
    ...
    <div class="container">
      ...
      <label for="email"><b>Whats your EV</b></label>
      <input type="text" placeholder="Enter your EV" name="EV" required>

      <label for="email"><b>Whats your EV's Range</b></label>
      <input type="text" placeholder="Enter your EV known Range" name="range" required>
